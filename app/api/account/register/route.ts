...
import { accountResponse, registerLabAccount } from '../../../../lib/lab-auth';
import { registerManagedAccount } from '../../../../lib/managed-auth';
...
export async function POST(req: NextRequest) {
  try {
    if (isRealDataMode()) {
      ...
      return await registerManagedAccount(await req.json());
    }
